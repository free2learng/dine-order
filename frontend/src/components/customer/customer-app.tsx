...
// Shared centering style for fixed overlays — keeps modals/drawers at 480px on desktop
const fixedSheet: React.CSSProperties = {
...
export function CustomerApp({ restaurant, table, categories, menuItems }: Props) {
    ...
    return (
      <div style={{ background: '#1a1a1a', minHeight: '100vh' }}>
        <div style={{
          ...
          <motion.div
            style={{ padding: '0 24px 56px', width: '100%', position: 'relative', boxSizing: 'border-box' }}
  ...
  return (
    <>
      ...
      {/* Outer dark desktop background */}
      <div style={{ background: '#1a1a1a', minHeight: '100vh' }}>

        {/* Single 480px phone column — header, tabs, cards all live here */}
        <div style={{
          maxWidth: 480,
          margin: '0 auto',
          background: CREAM,
          ...
          <header style={{
            ...
            {/* Category tabs — same column, no extra width wrapper */}
            {categories.length > 0 && (
              <div
                ref={tabsRef}
                className="dine-tabs"
          ...
          {/* ── Menu items — full width of the 480px column ──────────────── */}
